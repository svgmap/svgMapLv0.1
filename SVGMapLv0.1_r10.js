...
//		pts.style.height="80%";
		...
		pts.innerHTML='<span>Multiple candedates are overwrapped please select one.</span><br/><select id="ptsSelect" size="8" value="view Property"></select><br/><input type="button" id="ptsClose" value="Close"/>';
